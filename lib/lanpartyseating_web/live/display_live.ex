      ...
      <div class="flex flex-col grow">
        ...
        <div class="flex flex-wrap">
          <ul class="list-disc pl-4" style="font-size:19px">
            <li class="my-2">
              <b class="text-yellow-500">No spectators</b>. You need a reservation to be inside and to seat at a station
            </li>
            <li class="my-2">
              <b class="text-yellow-500">No free accounts</b>. You need to your own account to play games
            </li>
            ...
            <li class="my-2">
              ...
              <ul class="list-disc pl-4" style="font-size:17px">
                ...
                <li class="my-2">
                  Register your team or as a solo player at the info desk located at the room's entrance
                </li>
                <li class="my-2">
                  All tournaments are single elimination with prizes for the winning team
                </li>
              </ul>
            </li>
          </ul>
        ...
        <div class="flex flex-wrap">
          <ul class="list-disc pl-4" style="font-size:19px">
            <li class="my-2">
              <b class="text-yellow-500">Pas de spectateurs</b>. Il est nécessaire de faire une réservation avant d'entrer dans la zone et de s'asseoir
            </li>
            <li class="my-2">
              <b class="text-yellow-500">Pas de comptes de jeu gratuit</b>. Vous devez posséder des comptes pour jouer aux jeux
            </li>
            <li class="my-2">
              <b class="text-yellow-500">Pas de OSU</b> pour des raisons de droits d'auteur
            </li>
            <li class="my-2">
              ...
              <ul class="list-disc pl-4" style="font-size:17px">
                ...
                <li class="my-2">
                  Enregistrez-vous ou votre équipe au bureau d'information à l'entrée de la salle
                </li>
                <li class="my-2">
                  Tous les tournois sont à élimination simple avec des prix pour l'équipe gagnante
                </li>
              </ul>
            </li>
          </ul>
