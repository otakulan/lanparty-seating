      ...
      <div class="modal modal-bottom sm:modal-middle">
        <div class="modal-box">
          ...
          <form phx-submit="create_tournament">
            ...
            <input type="text" placeholder="Tournament Name" class="w-full max-w-xs input input-bordered" name="name"/>
<br>
            <label for={"start_time"} class="">Start time:</label>
            <input type="datetime-local" class="w-full max-w-xs input input-bordered" min="2023-08-10T00:00" max="2023-08-14T00:00" name="start_time"/>
<br>
            <label for={"duration"} class="">Duration:</label>
            <input id="duration" name="duration" class=" input input-bordered" type="time">
