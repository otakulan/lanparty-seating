defmodule Lanpartyseating.Accounts do
  @moduledoc """
  ...
  See `Lanpartyseating.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Lanpartyseating.Accounts.User.password_changeset/3` for a list of supported options.
